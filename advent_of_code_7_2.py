...
total_vol_size = 70000000
total_used = 0
free_space_required = 30000000
for dir in directories:
    if dir.name == '/':
        total_used = dir.total_size

available_space = total_vol_size - total_used
extra_space_required = free_space_required - available_space

min_large_enough = 9999999999
for dir in directories:
    if dir.total_size >= extra_space_required:
        if dir.total_size < min_large_enough:
            min_large_enough = dir.total_size

print(min_large_enough)
